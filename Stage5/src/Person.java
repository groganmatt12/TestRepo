...
ArrayList <String> occupations = new ArrayList<String>();
	...
	public Person(String name, String surname, String dob, String nationality, String visaInfo)	//person not from UK
	{
		this.name = name;
		this.surname = surname;
		this.dob = dob;
	...
	public Person(String name, String surname, String dob, String nationality, String visaInfo, ArrayList<String> Occupations)	//with occupations, not from UK
	{
		this.name = name;
		this.surname = surname;
		this.dob = dob;
...
//getters and setters//
	...
	{
		return this.name + "_" + this.surname + "_" + this.dob + "_" + this.nationality + "_" + this.getVisaInfo();
	}
